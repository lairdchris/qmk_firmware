...
* |-----------------------------------------------------------------------------------------+
* | Caps    |  a  |  r  |  s  |  t  |  g  |  h  |  n  |  e  |  i  |  o  |  '  |    Enter    |
* |-----------------------------------------------------------------------------------------+
...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */
    ...
    LT(FN1, KC_ESC),  LSFT_T(KC_A), LCTL_T(KC_R), LALT_T(KC_S), LGUI_T(KC_T), LT(L4,KC_G), LT(4,KC_M), LGUI_T(KC_N), LALT_T(KC_E), LCTL_T(KC_I), LSFT_T(KC_O), KC_QUOT,       KC_ENT,
    KC_LSFT,          KC_Z,         KC_X,         KC_C,         KC_D,         KC_V,        KC_K,       KC_H,         KC_COMM,      KC_DOT,       KC_SLSH,      RSFT_T(KC_UP),
    KC_LCTL,          KC_LGUI,      KC_LALT,                    LT(FN2, KC_SPC),                    KC_RALT, LT(FN1, KC_LEFT), LT(FN2, KC_DOWN), RCTL_T(KC_RGHT)
),
  /*
  * Layer FN1
  * ,-----------------------------------------------------------------------------------------.
